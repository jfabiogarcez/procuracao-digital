...
export default function Home() {
  ...
  return (
    <>
      <header className="bg-[#1a2847] text-white py-4 px-6 shadow-md">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <h1 className="text-2xl font-bold">JFG ADVOCACIA</h1>
          <a
            href="/admin/login"
            className="bg-white text-[#1a2847] px-4 py-2 rounded-md font-semibold hover:bg-gray-100 transition-colors"
          >
